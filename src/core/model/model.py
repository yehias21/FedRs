...
class NeuMF(nn.Module):
    ...
    def forward(self,item_indices):
        ...
        mlp_vector = torch.cat([self.embedding_user_mlp, item_embedding_mlp], dim=-1)  # the concat latent vector
        mf_vector = torch.mul(self.embedding_user_mf, item_embedding_mf)
